...
exports.mindMapGraphOption = {
    ...
    layout: {
        ...
        getWidth: function (node) {
            return node.level === 0 ? es_1.Util.getTextSize(node.label, 16)[0] + 12 : es_1.Util.getTextSize(node.label, 12)[0];
        },
        getVGap: function () {
            return 10;
        },
...
var MindMapGraph = /** @class */ (function (_super) {
    ...
    function MindMapGraph(userConfig) {
        var _this = _super.call(this, config_1.mixConfig(exports.mindMapGraphOption, userConfig)) || this;
        _this.tree = true;
        return _this;
    }
